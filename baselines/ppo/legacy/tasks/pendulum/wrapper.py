"""
Source: github.com/gsurma/atari/blob/master/gym_wrappers.py
Modified from: https://github.com/openai/baselines/blob/master/baselines/common/atari_wrappers.py
"""
import numpy as np
