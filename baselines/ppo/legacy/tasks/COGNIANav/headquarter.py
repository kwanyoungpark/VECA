...
class HeadQuarter():
    def __init__(self, env, model):
        ...
        self.objwav = np.zeros([NUM_AGENTS])
    ...
    def send_action(self):
        data = {'image':self.img1, 'audio':self.wav1, 'touch': self.touch1}
    ...
    def collect_observations(self, add_replay = True):
        ...
        self.pos1, self.objimg, self.objaudio, self.objtactile = infos['pos'], infos['objimg'], infos['objwav'], infos['objtouch']
        #print("Reward : ")
        ...
        for j in range(NUM_AGENTS):
            ...
            self.helper_reward[j] += getRewardFromPos(self.pos0[j], action[j])
