...
from tasks.MANavigation.utils import *
...
from tasks.MANavigation.constants import FRAME_SKIP
from tasks.MANavigation.replaybuffer import ReplayBuffer
import pickle
...
class HeadQuarter():
    ...
    def restart(self):
        ...
        imgs, wavs, objs = obs['image'], obs['audio'], obs['obj']
        #print(others.shape)
        ...
        self.pos1, self.posA1 = infos
    
    def add_replay_buf(self, buf):
        buf.add_replay(self.img0, self.img1, self.wav0, self.wav1, self.action, self.helper_reward, self.raw_reward, self.pos0, self.pos1, self.obj0, self.done)
    ...
    def send_action(self):
        ...
        data = {'image':self.img1, 'audio':self.wav1, 'obj':self.obj1}
    ...
    def step(self, add_replay = True):
        self.send_action()
        self.collect_observations(add_replay) 
